...
void main()
{
    ...
    int pin = 1234, option, entered_pin, count = 0, amount = 1; // functions are defined here
    ...
    while (continue_transaction != 0)
    {
        ...
        case 1:
            ...
            else
            {
                ...
                printf("\n\t\tYou have withdraw RMB.%d. Your new balance is %.2f", amount, balance);
            ...
            case 2:
                ...
                printf("\n\t\tYou have deposited RMB.%d. Your new balance is %2f", amount, balance);
            ...
            case 3:
                ...
                printf("\n\t\t Your balance is RMB.%.2f", balance);
